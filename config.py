...
class RiskThresholds:
    ...
    # Above suspicious_max = HIGH_RISK
...
class NLPConfig:
    ...
    candidate_labels: List[str] = field(default_factory=lambda: [
        "phishing attack", "impersonation fraud", "financial scam", "legitimate communication"
    ])
